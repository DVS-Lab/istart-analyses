...
def infotodict(seqinfo):
    ...
    srSocial = create_key('sub-{subject}/func/sub-{subject}_task-srSocial_run-{item:02d}_bold')
    srSocial_sbref = create_key('sub-{subject}/func/sub-{subject}_task-srSocial_run-{item:02d}_sbref')
    
    srDoors = create_key('sub-{subject}/func/sub-{subject}_task-srDoors_run-{item:02d}_bold')
    srDoors_sbref = create_key('sub-{subject}/func/sub-{subject}_task-srDoors_run-{item:02d}_sbref')
